...
app.get('*', function (req, res, next) {
    ...
    promise.then(function (data) {
        ...
        res.send('\n                <html>\n                    <head>\n                        <title>RRSSR</title>\n                        <script src=\'/bundle.js\' defer></script>\n                        <script>window.__INITIAL__STETE__=' + (0, _serializeJavascript2.default)(data) + '</script>\n                    </head>\n                    <body>\n                        <div id="app">' + markup + '</div>\n                    </body>\n                </html>\n            ');
    }).catch(next);
});

app.listen(80, function () {
    return console.log('runing from port 80');
});
...
var Grid = function (_Component) {
    ...
    function Grid(props) {
        ...
        var repos = void 0;
        if (false) {
            repos = window.__INITIAL__STETE__;
            delete window.__INITIAL__STETE__;
        } else {
